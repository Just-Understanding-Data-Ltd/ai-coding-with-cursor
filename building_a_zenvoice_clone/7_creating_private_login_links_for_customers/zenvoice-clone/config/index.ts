...
export const config: AppConfig = {
  ...
  company: {
    name: "Invoicely Inc.",
    address: "123 Invoice Street, San Francisco, CA 94105",
    ...
    usps: [
      {
        ...
        description:
          "Connect your Stripe account and start using Zenvoice in minutes.",
        icon: "Clock",
      },
      {
      ...
      },
      {
        ...
        description: "Save on Stripe's 0.4% invoice fee by using Zenvoice.",
        icon: "DollarSign",
      },
    ],
    testimonials: [
      ...
      },
      {
        ...
        quote:
          "Zenvoice has saved us countless hours in customer support. Our clients love the self-serve invoice feature!",
      },
      {
        name: "Michael Chen",
        company: "SaaS Entrepreneur",
        quote:
          "The time and money we've saved with Zenvoice has been a game-changer for our business. Highly recommended!",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Zenvoice automates the invoice generation process, saving you time and reducing customer support requests related to invoices.",
      },
      {
        question: "How does Zenvoice work with Stripe?",
        answer:
          "Zenvoice integrates seamlessly with your Stripe account, allowing customers to generate invoices for their purchases without you having to manually create them.",
      },
      {
        question: "Is Zenvoice secure?",
        answer:
          "Yes, Zenvoice uses industry-standard security practices and doesn't store sensitive payment information. We only use restricted API keys to interact with your Stripe account.",
      },
      {
        question: "Can I customize the invoice template?",
        answer:
          "Currently, Zenvoice uses Stripe's default invoice template. We're working on adding customization options in future updates.",
      },
      {
        question: "Does Zenvoice work with other payment processors?",
        answer:
          "At the moment, Zenvoice is designed to work exclusively with Stripe. We may consider adding support for other payment processors in the future.",
      },
      {
        question: "How much time can I save using Zenvoice?",
        answer:
      ...
      },
      {
        ...
        answer:
          "No, there's no limit to the number of invoices you can generate with Zenvoice. Our pricing is not based on invoice volume.",
      },
      {
      ...
      {
        question: "Do I need technical knowledge to set up Zenvoice?",
        answer:
          "Not at all! Zenvoice is designed for easy setup without any coding required. You can be up and running in just a few minutes.",
      },
      {
        question: "What kind of support does Zenvoice offer?",
        answer:
